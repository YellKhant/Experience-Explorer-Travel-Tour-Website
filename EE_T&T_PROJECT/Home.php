...
<head>
    <title>Experience Explorer Travel & Tours Website Home</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
						...
						<li class="nav-item  mr-3 mt-lg-0 mt-3">
                            <a class="nav-link" href="Package_Display.php">Available Packages</a>
                        </li>
...
<!-- 							<div class="col-md-4 form-group news-rt">
							...
							<div class="col-md-4 form-group news-lt">
								<a class="form-control submit text-uppercase" href="Customer_Entry.php">Register Now</a>
							</div>
							<div class="col-md-4 form-group news-last">
								<div class="sbm-it">
									<div class="form-group">
										<a class="form-control submit text-uppercase" href="Customer_Login.php">Login Account</a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-5 section-4">
					<div class="agil_mor">
						...
						<p class="vam">Experience Explorer Travel & Tours is one of the best companies in Myanmar where everyone can find the best services and customer care.</p>
						<a href="about.php" class="mt-3">Read More</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-5 section-5">
					<div class="agil_mor">
						...
						<p class="vam">Main services of Experience Explorer Travel & Tours Company are inbound tour service and transporting passengers to the most famous, historical and beautiful places of Myanmar.</p>
						<a href="about.php" class="mt-3">Read More</a>
					</div>
				</div>
				<div class="col-lg-7">
 ...
 <!-- stats -->
            ...
            <div class="py-lg-5 w3-abbottom">
                <div class="row py-5">
                    <div class="counter col-lg-3 col-6">
                        ...
                        <div class="timer count-title count-number mt-2 text-white" data-to="3358" data-speed="1500"></div>
                        <p class="count-text text-capitalize text-white">HAPPY CLIENTS</p>
                    </div>

                    <div class="counter col-lg-3 col-6">
                        <i class="fas fa-fighter-jet"></i>
                        <div class="timer count-title count-number mt-2 text-white" data-to="73" data-speed="1500"></div>
                        <p class="count-text text-capitalize text-white">AMAZING TOURS</p>
                    </div>
                    <div class="counter col-lg-3 col-6 mt-lg-0 mt-4">
                        <i class="fas fa-users"></i>
                        <div class="timer count-title count-number mt-2 text-white" data-to="20" data-speed="1500"></div>
    ...
    <div class="more-services py-lg-5">
		<div class="container py-5">
            <div class="title-section pb-sm-5 pb-3">
               <h3 class="heading-agileinfo text-center pb-4">Popular <span> Tours</span></h3>
            </div>
            <div class="row grid">
	...
	<div class="testimonials py-lg-5">
		<div class="container py-5">
			 <div class="title-section pb-sm-5 pb-3">
               <h3 class="heading-agileinfo text-center text-white pb-4">Our <span> Team Members</span></h3>
            </div>
			<div class="mis-stage">
				...
				<ol class="mis-slider">
					...
					<li class="mis-slide">
						<a href="#" class="mis-container">
							<figure>
								<img src="images/te7.jpg" alt=" " class="img-fluid" />
								<figcaption>Kyaw
			...
			<div class="row footer-top-w3layouts-agile py-5">
				<div class="col-md-4 footer-grid">
					...
					<div class="footer-text">
						<p>Experience Explorer Travel & Tours company was founded in 1999 by the founder Mr. Kyaw Lin</p>
					</div>
				</div>
				<div class="col-md-4 footer-grid">
					<div class="footer-title">
